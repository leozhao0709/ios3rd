...
extension UIButton {
     ...
     */
    public func setImage(_ normalImage: UIImage?, highlightImage: UIImage?, selectedImage: UIImage? = nil){
    ...
    public func setBackgroundImage(_ normalImage: UIImage?, highlightImage: UIImage?, selectedImage: UIImage? = nil) {
    ...
    public func setTitleColor(_ normalColor: UIColor?, highlightColor: UIColor?, selectedColor: UIColor? = nil, disabledColor: UIColor? = nil) {
